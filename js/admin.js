...
function loadAdminDashboard() {
    ...
    // Chart 1: Global Revenue (Line Chart)
        ...
        new Chart(salesCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [850000, 1200000, 1450000, 1100000, 1950000, totalRevenue > 0 ? totalRevenue : 1500000],
                    borderColor: "#3b82f6",
    ...
    // Chart 2: Product Types stats
    const prodCtx = document.getElementById("adminProductChart");
    if (prodCtx) {
        ...
        new Chart(prodCtx, {
            ...
            options: {
                responsive: true,
                maintainAspectRatio: false,
                plugins: { legend: { position: "bottom", labels: { boxWidth: 10, font: { weight: "bold", size: 9 } } } }
            }
        });
    }
}
...
function loadAdminReports() {
    ...
    // Render global reports chart (Bar Chart)
